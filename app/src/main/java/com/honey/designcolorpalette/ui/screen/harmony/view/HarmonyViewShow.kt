...
import com.honey.designcolorpalette.extencion.getFullHarmony
import com.honey.designcolorpalette.extencion.string
import com.honey.designcolorpalette.extencion.toHexString
import com.honey.designcolorpalette.extencion.toStringRGB
...
fun HarmonyViewShow(
    ...
    onSwapCopyMode: () -> Unit,
    onSave: (ColorScheme: CustomColorScheme) -> Unit,
                ...
                Card(
                    ...
                    SwapNameSaveRow(
                        ...
                        onSave = { name ->
                            onSave.invoke(
                                CustomColorScheme(
                                    colors = colors.map { ColorInfo(value = it.string(), name = "") },
                                    name = name,
